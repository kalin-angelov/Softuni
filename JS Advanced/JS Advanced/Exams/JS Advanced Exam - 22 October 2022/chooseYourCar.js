const chooseYourCar = {
    ...
    carFuelConsumption(distanceInKilometers, consummatedFuelInLiters) {

        let litersPerHundredKm =((consummatedFuelInLiters / distanceInKilometers)* 100).toFixed(2);

        if (typeof distanceInKilometers !== "number" || distanceInKilometers <= 0 ||
            typeof consummatedFuelInLiters !== "number" || consummatedFuelInLiters <= 0) {
            throw new Error("Invalid Information!");
